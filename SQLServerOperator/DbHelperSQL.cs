...
namespace SQLServerOperator
{
    ...
    public class DbHelperSQL
    {
        ...
        public string connectionString = "server={0};uid={1};pwd={2};database={3};";

        public string sqlpath = System.AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "\\SQLXML\\SQL.xml";
        ...
        /// <param name="SQLString">SQL语句</param>
        /// <returns>影响的记录数</returns>
        public int ExecuteSql(SqlConnection connection, SqlTransaction trans, string SQLString)
        {
            using (SqlCommand cmd = new SqlCommand(SQLString, connection))
            {
                try
        ...
        /// <param name="SQLString">SQL语句</param>
        /// <returns>DataSet</returns>
        public DataSet Query(SqlConnection connection, SqlTransaction trans, string SQLString)
        {
            DataSet ds = new DataSet();
            try
            {
        ...
        public int ExecuteSql(string routecode, Hashtable hs)
        {
            try
            {
                string sql = GetSQLStr(routecode, hs);
        ...
        /// <param name="hs"></param>
        /// <returns></returns>
        public DataTable Query(string routecode, Hashtable hs)
        {
            try
            {
                string sql = GetSQLStr(routecode, hs);
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public DataSet Query(SqlConnection connection, SqlTransaction trans, string SQLString, params SqlParameter[] cmdParms)
        {
            SqlCommand cmd = new SqlCommand();
            PrepareCommand(cmd, connection, trans, SQLString, cmdParms);
            using (SqlDataAdapter da = new SqlDataAdapter(cmd))
