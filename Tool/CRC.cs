 ...
 0x40
        ...
        public static byte XOR(byte Base, byte[] Data)
        {
            try
            {
                ...
                int d = Convert.ToInt32(ss);
                d = ~d;
                byte[] bb = BitConverter.GetBytes(d);
                return bb[0];
            }
            catch (Exception ex)
            { throw ex; }
        ...
        public static byte CRC_8(byte[] buffer, int off, int len)
        {
            try
            {
                byte crc = 0;
        ...
        public static byte[] ToByte(double data)
        {
            try
            {
                byte[] dd = BitConverter.GetBytes((int)(data*1000));
                return dd;
